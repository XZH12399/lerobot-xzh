...
from lerobot.policies.pi0_residual.configuration_pi0_residual import PI0ResidualConfig
from lerobot.policies.pi0_residual_every_step.configuration_pi0_residual_every_step import PI0ResidualEveryStepConfig
...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        return PI0Policy
    elif name == "pi0_anchor":
        from lerobot.policies.pi0_anchor.modeling_pi0_anchor import PI0AnchorPolicy

        return PI0AnchorPolicy
    elif name == "pi0_residual":
        from lerobot.policies.pi0_residual.modeling_pi0_residual import PI0ResidualPolicy

        return PI0ResidualPolicy
    elif name == "pi0_residual_every_step":
        from lerobot.policies.pi0_residual_every_step.modeling_pi0_residual_every_step import PI0ResidualEveryStepPolicy

        return PI0ResidualEveryStepPolicy
    elif name == "pi0_residual_laststep":
        from lerobot.policies.pi0_residual_laststep.modeling_pi0_residual_laststep import PI0ResidualLastStepPolicy

        return PI0ResidualLastStepPolicy
    elif name == "pi0_fast":
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "pi0_anchor":
        return PI0AnchorConfig(**kwargs)
    elif policy_type == "pi0_residual":
        return PI0ResidualConfig(**kwargs)
    elif policy_type == "pi0_residual_every_step":
        return PI0ResidualEveryStepConfig(**kwargs)
    elif policy_type == "pi0_residual_laststep":
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, PI0ResidualConfig):
        from lerobot.policies.pi0_residual.processor_pi0_residual import make_pi0_residual_pre_post_processors

        processors = make_pi0_residual_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )

    elif isinstance(policy_cfg, PI0ResidualEveryStepConfig):
        from lerobot.policies.pi0_residual_every_step.processor_pi0_residual_every_step import make_pi0_residual_every_step_pre_post_processors

        processors = make_pi0_residual_every_step_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )

    elif isinstance(policy_cfg, PI0ResidualLastStepConfig):
        from lerobot.policies.pi0_residual_laststep.processor_pi0_residual_laststep import make_pi0_residual_laststep_pre_post_processors

        processors = make_pi0_residual_laststep_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
    ...
    if isinstance(policy_cfg, TDMPCConfig):
    ...
    elif isinstance(policy_cfg, PI0AnchorConfig):
        from lerobot.policies.pi0_anchor.processor_pi0_anchor import make_pi0_anchor_pre_post_processors

        processors = make_pi0_anchor_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
        ...
        processors = make_pi05_memory_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
