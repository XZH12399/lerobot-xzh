...
def rollout(
    ...
    while not np.all(done) and step < max_steps:
        ...
        forced_task = os.getenv("LEROBOT_FORCE_TASK_TEXT", "").strip()
        if forced_task:
            num_envs = observation[list(observation.keys())[0]].shape[0]
            observation["task"] = [forced_task for _ in range(num_envs)]
    ...
    for batch_ix in progbar:
        ...
        if debug_stats_infer is None:
            ...
            if stats:
                ...
                print("debug_stats_infer:", debug_stats_infer)
        ...
        if debug_stats_infer_steps is None:
            ...
            if step_stats:
                ...
                print("debug_stats_infer_steps:", debug_stats_infer_steps)
